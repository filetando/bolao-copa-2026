-- =====================================================================
-- Tabela: confrontos_terceiros
-- Origem: Anexo C da FIFA - Tabela de cruzamentos dos 8 melhores
--         3os colocados da fase de grupos (Copa do Mundo de 2026)
--
-- COMO USAR:
-- 1. Ao final da fase de grupos, identifique as letras dos grupos cujos
--    3os colocados se classificaram (sempre 8 das 12 letras A..L).
-- 2. Ordene essas letras alfabeticamente e concatene em uma string
--    de 8 caracteres. Ex: grupos C,E,F,G,H,I,J,L classificados ->
--    combinacao = 'CEFGHIJL'
-- 3. Faca: SELECT * FROM confrontos_terceiros WHERE combinacao = 'CEFGHIJL'
-- 4. O resultado informa, para cada vencedor de grupo (1A,1B,1D,1E,1G,1I,1K,1L),
--    qual grupo (letra) fornece o adversario 3o colocado.
--    Ex: vs_1a = 'E'  =>  1o colocado do Grupo A enfrenta o 3o colocado do Grupo E.
--
-- OBS: Os campeoes dos grupos C, F, H e J NAO aparecem nesta tabela porque
-- eles sempre enfrentam 2os colocados (regra fixa, nao depende da combinacao).
-- =====================================================================

CREATE TABLE confrontos_terceiros (
    id          INTEGER PRIMARY KEY AUTOINCREMENT,  -- use SERIAL/IDENTITY no Postgres/MySQL
    combinacao  CHAR(8)  NOT NULL UNIQUE, -- 8 letras dos grupos classificados, em ordem alfabetica (ex: 'CDEFGHIJ')
    vs_1a       CHAR(1)  NOT NULL,        -- letra do grupo do 3o colocado que enfrenta o 1o do Grupo A
...
INSERT INTO confrontos_terceiros (combinacao, vs_1a, vs_1b, vs_1d, vs_1e, vs_1g, vs_1i, vs_1k, vs_1l) VALUES
